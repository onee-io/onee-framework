...
public class RedisUtil {
     ...
     * 获取redis锁
     */
    public DistributedReentrantLock getLock(String lockKey) {
        return new RedisReentrantLock(redissonClient, lockKey);
    }
     ...
     * 执行Lua脚本
     */
    public String executeScript(String scriptText, List<String> keys, Object... args) {
        return this.redisTemplate.execute(new DefaultRedisScript<>(scriptText), keys, args);
    }
}